...
export const AI_CONFIG = {
  model: "claude-opus-5",
  // DE STORING VAN 6 SEPTEMBER 2026 KWAM HIER NIET VANDAAN.
  // -------------------------------------------------------------------------
  // Toen viel de perssynthese uit en is maxTokens van 2000 naar 8000 gegaan,
  // met de redenering hieronder als verklaring. Die verklaring was FOUT. De
  // oorzaak was een ONGELDIGE ANTHROPIC_API_KEY: elke aanroep kwam terug met
  // HTTP 401, en dat was onzichtbaar omdat het draailog alleen de telling
  // "mislukt=5" gaf. Vastgesteld op 7 september 2026.
  //
  // Deze waarde staat er dus als voorzorg, niet als reparatie. Wie hier over
  // een half jaar komt kijken omdat de concepten weer stilliggen: kijk EERST
  // in het draailog naar een regel "[pers] synthese afgebroken" met een
  // HTTP-status, en naar invariant I17 van de sonde. Beide bestaan sinds die
  // dag juist omdat ze er toen niet waren.
  //
  ...
  // in lib/synthese.js een harde fout. Dat kán gebeuren; het is alleen niet
...
// ---- Meting van het menugebruik --------------------------------------------
// Eén sleutel per dag, een Redis-hash met een teller per ingang. Eén sleutel
// per dag en niet één per ingang: dan is een dag in één opdracht te lezen en
// verloopt hij als geheel.
//
// PRODUCTIE EN PROEF GESCHEIDEN. Preview-deploys draaien met dezelfde KV-
// gegevens als productie. Zonder scheiding zou elke keer dat iemand een preview
// opent de echte cijfers vervuilen — en juist bij een meetinstrument is dat
// dodelijk, want niemand ziet het aan het getal af.
export const METING_PREFIX = `${KV_PREFIX}meting:`;
export const METING_PROEF_PREFIX = `${KV_PREFIX}meting-proef:`;
export const KEY_METING = (dag, proef) =>
  `${proef ? METING_PROEF_PREFIX : METING_PREFIX}${dag}`;
// 400 dagen: ruim een jaar, zodat een seizoensvergelijking mogelijk is zonder
// dat de reeks eindeloos doorgroeit. Proefdata gaat na een week weg.
export const METING_TTL_S = 400 * 24 * 60 * 60;
export const METING_PROEF_TTL_S = 7 * 24 * 60 * 60;
export const METING_DAGEN_STANDAARD = 14;
export const METING_DAGEN_MAX = 90;
