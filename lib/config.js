...
// ---- Versiestempel van de reviewtool ---------------------------------------
// WAAROM DIT ER IS. Zonder stempel is er geen manier om te zien of je naar de
// nieuwe tool kijkt of naar een oude pagina uit de browsercache — twee
// versies van deze tool lijken van een afstand sprekend op elkaar. De
// reviewtool toont daarom een versie, een datum en de commit die live staat.
//
// Versie en datum zijn HANDWERK: ze horen bij een verandering die de redactie
// merkt, niet bij elke commit. De commit-hash ernaast komt uit de omgeving van
// Vercel en is dus niet te vervalsen — lopen die twee uiteen, dan is de stempel
// vergeten bij te werken en zie je dat meteen.
export const APP_VERSIE = "2.1";
export const APP_VERSIE_DATUM = "2026-08-30";
