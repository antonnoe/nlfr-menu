...
.bnr-vraag { position:relative; flex:none; width:30px; height:30px; border-radius:999px; border:0; cursor:pointer;
             background:#800000; color:#fff; font-family:'Poppins', system-ui, -apple-system, "Segoe UI", Roboto, sans-serif; font-weight:700;
...
.bnr-boek { font-family:'Mulish', system-ui, -apple-system, "Segoe UI", Roboto, sans-serif; font-size:13px; font-style:italic; color:rgba(128,0,0,.8); margin-top:2px; }
.bnr-datum { font-family:'Mulish', system-ui, -apple-system, "Segoe UI", Roboto, sans-serif; font-size:13px; font-weight:700; color:#800000; margin-top:3px; }
.bnr-onder { font-family:'Mulish', system-ui, -apple-system, "Segoe UI", Roboto, sans-serif; font-size:12px; color:rgba(128,0,0,.8); margin-top:2px; }
.bnr-knop { flex:none; display:inline-flex; align-items:center; justify-content:center;
            ...
            font-family:'Poppins', system-ui, -apple-system, "Segoe UI", Roboto, sans-serif; font-weight:700; font-size:14px; letter-spacing:.02em; }
...
.bnr-uitleg { margin-top:8px; padding:12px 14px; border:1px solid rgba(128,0,0,.14);
              border-radius:6px; background:#fff; font-family:'Mulish', system-ui, -apple-system, "Segoe UI", Roboto, sans-serif;
