...
import { teaser as verenigingTeaser } from "./verenigingen.js";
import {
  OVERHEID_THEMAS,
  ...
  if (ver.length) {
    tegels.push({
      ...
      artikelen: ver.map((i) => ({
        ...
        soort: "verenigingen",
        titel: i.titel,
        // GEEN TERUGVAL OP DE TITEL. Bij de andere tegels is `|| i.titel` een
        // nette vangregel, maar hier zou hij de titel dubbel op het scherm
        // zetten: één keer als kop en één keer als onderregel. Een lege teaser
        // betekent hier "toon alleen de titel", en dat is precies wat punt 2
        // vraagt bij een halve zin. Zie lib/verenigingen.js.
        summary: verenigingTeaser(i.samenvatting, eersteZin).tekst,
        tekst: i.samenvatting || "",
        bronnen: schoneBronnen(
