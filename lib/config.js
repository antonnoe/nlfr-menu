...
export const BOSBRAND_WOORDEN = [
  "brand", "branden", "bosbrand", "bosbranden", "natuurbrand", "vlammen",
  "incendie", "incendies", "feu", "feux", "flamme", "pompier", "pompiers",
  "evacu", // evacuatie / évacuation / évacués
];
export const PERS_TEGELS = ["bosbranden", "landelijk", "regionaal"];
export const PERS_TEGEL_LABEL = {
  bosbranden: "Zuid-Frankrijk — bosbranden",
  landelijk: "Landelijk & internationaal",
  regionaal: "Zuid-Frankrijk — regionaal",
};
